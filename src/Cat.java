...
public class Cat {
	...
	private static final int MOUTH_X = HEAD_DIMENSION/20 * 8;
	private static final int MOUTH_Y = HEAD_DIMENSION/10 * 6;
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		g2.drawString("Where is Jerry?", catX + 60, catY+HEAD_DIMENSION+70);	
	}
}
